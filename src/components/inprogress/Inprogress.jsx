...
function Inprogress() {
  ...
  return (
    <div className="lg:w-95 md:w-60 h-auto min-h-118 p-3 bg-fuchsia-100 flex flex-col items-center justify-center relative">
      <div className="w-full h-40 flex items-center justify-center flex-col absolute top-2.5">
        <h1 className="lg:text-[20px] md:text-[15px] font-extralight">In Progress</h1>
